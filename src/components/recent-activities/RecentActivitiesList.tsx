...
type RecentActivitiesListProps = {
    ...
    ActivityCard: (list: DatasetActivity[] | InstructionActivity[]) => JSX.Element[]
}

export default function RecentActivitiesList({ resource, ActivityCard, LoadingListComponent }: RecentActivitiesListProps) {
